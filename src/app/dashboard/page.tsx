            ...
            <div style={{ position: "relative", zIndex: 1, maxWidth: "1000px", margin: "0 auto", padding: "50px 24px 80px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "40px", flexWrap: "wrap", gap: "16px" }}>
                    <div className="animate-slide-up">
                        ...
                        <p style={{ color: "rgba(175,175,210,0.7)", fontSize: "15px" }}>
                            Track your quiz progress and start new challenges.
                        </p>
                    </div>
                    <Link href="/upload">
                ...
                >
                    {stats.map((s, i) => (
                        <div key={i} className="glass card-hover" style={{ padding: "24px" }}>
                            ...
                            <div style={{ fontSize: "28px", fontWeight: 800, marginBottom: "4px", color: "#6b8cff" }}>
                                {s.value}
                            </div>
                ...
                <div>
                    ...
                    {attempts.length === 0 ? (
                        ...
                        >
                            ...
                            <p style={{ color: "rgba(175,175,210,0.6)", marginBottom: "28px", fontSize: "15px" }}>
                                Generate your first AI-powered quiz from any document or text.
                            </p>
                            <Link href="/upload">
                                <button className="btn-primary">🤖 Generate First Quiz</button>
                            </Link>
                        </div>
                    ) : (
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div style={{ flex: 1, minWidth: "160px" }}>
                                            <div style={{ fontWeight: 700, fontSize: "15px", marginBottom: "4px", color: "#f0f0ff" }}>
                                                {attempt.quiz.title}
                                            </div>
                                            <div style={{ display: "flex", gap: "10px", alignItems: "center", flexWrap: "wrap" }}>
                                                <span className={getDifficultyBadge(attempt.quiz.difficulty)}>{attempt.quiz.difficulty}</span>
                                                <span style={{ fontSize: "12px", color: "rgba(175,175,210,0.5)" }}>
                                                    {attempt.score}/{attempt.totalQuestions} correct
                                                </span>
                                                <span style={{ fontSize: "12px", color: "rgba(175,175,210,0.4)" }}>
