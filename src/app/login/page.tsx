            ...
            <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 72px)", padding: "40px 24px" }}>
                <div className="glass-strong animate-slide-up" style={{ width: "100%", maxWidth: "440px", padding: "48px 40px" }}>
                    <div style={{ textAlign: "center", marginBottom: "36px" }}>
                        ...
                        <p style={{ color: "rgba(175,175,210,0.7)", fontSize: "14px" }}>Sign in to continue to QuizAI</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                        <div>
                            <label style={{ display: "block", fontSize: "13px", fontWeight: 600, color: "rgba(175,175,210,0.9)", marginBottom: "8px", letterSpacing: "0.3px" }}>Email Address</label>
                    ...
                    <p style={{ textAlign: "center", fontSize: "14px", color: "rgba(175,175,210,0.7)" }}>
                        ...
                        <Link href="/register" style={{ color: "#6b8cff", fontWeight: 600, textDecoration: "none" }}>Create one free</Link>
                    </p>
                </div>
            </div>
        </div>
