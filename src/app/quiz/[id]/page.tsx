    ...
    if (!session) {
        return (
            <div style={{ textAlign: "center", padding: "120px 24px" }}>
                <p style={{ color: "rgba(175,175,210,0.7)" }}>
                    Please <a href="/login" style={{ color: "#6b8cff" }}>sign in</a> to take quizzes.
                </p>
            </div>
        );
    }
        ...
        <div style={{ position: "relative", minHeight: "calc(100vh - 72px)" }}>
            ...
            >
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px", flexWrap: "wrap", gap: "12px" }}>
                        <div>
                            ...
                            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                                ...
                                <span style={{ color: "rgba(175,175,210,0.5)", fontSize: "13px" }}>
                        ...
                        <div style={{ textAlign: "right" }}>
                            <div style={{ fontSize: "28px", fontWeight: 800, color: "#6b8cff" }}>
                                {currentQ + 1}
                                <span style={{ fontSize: "16px", fontWeight: 400, color: "rgba(175,175,210,0.5)" }}>
                ...
                >
                    ...
                    <p style={{ fontSize: "18px", fontWeight: 600, lineHeight: 1.6, marginBottom: "28px", color: "#f0f0ff" }}>
                                ...
                                >
                                    <span
                                        style={{
                                            ...
                                            height: "32px",
                                            borderRadius: "50%",
                                            background: isSelected ? "rgba(79, 110, 247, 0.3)" : "rgba(255,255,255,0.06)",
                                            display: "flex",
                                            alignItems: "center",
                                            ...
                                            fontWeight: 700,
                                            flexShrink: 0,
                                            border: isSelected ? "1px solid rgba(79, 110, 247, 0.5)" : "1px solid rgba(255,255,255,0.08)",
                                            color: isSelected ? "#6b8cff" : "rgba(175,175,210,0.7)",
                                        }}
                                    >
                                        {opt}
                                    </span>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "12px" }}>
                    ...
                    {currentQ < quiz.questions.length - 1 ? (
                        <button className="btn-primary" onClick={handleNext} id="next-btn">
                            Next →
                        </button>
                    ) : (
                        <button
